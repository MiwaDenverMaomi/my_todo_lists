 ...
 <div class="row mx-auto">
          ...
          @auth
					...
					<a class="text-decoration-none" href="{{route('login.getLogin')}}">
					  <i id="like-id_{{$user_data['id']}}" class="bi bi-heart-fill icon-grey"></i><strong class="text-decoration-none" style="font-size:1.5rem;" id="count_likes_{{$user_data['id']}}">{{$user_data['countLikes']}}</strong>
					</a>
					@endguest
					@auth
