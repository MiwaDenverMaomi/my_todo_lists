...
/* harmony export */   "onToggleLike": () => (/* binding */ onToggleLike),
/* harmony export */   "previewFile": () => (/* binding */ previewFile),
/* harmony export */   "sanitize": () => (/* binding */ sanitize),
/* harmony export */   "searchKeyword": () => (/* binding */ searchKeyword)
/* harmony export */ });
/* harmony import */ var _apis_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../apis/axios */ "./resources/apis/axios.ts");
...
var onToggleLike = function onToggleLike(user, is_liked_by_auth) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var result, $likes_result_element, _result$data, _is_liked_by_auth, count_likes, $heart_element, $count_likes_element;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(result);
            $likes_result_element = document.querySelector("#likes_result_".concat(user));
          ...
          case 14:
            ...
            _result$data = _slicedToArray(result.data, 2), _is_liked_by_auth = _result$data[0], count_likes = _result$data[1];
            $heart_element = document.querySelector("#like-id_".concat(user));
            $count_likes_element = document.querySelector("#count_likes_".concat(user));
...
window.onToggleLike = (__webpack_require__(/*! ./func */ "./resources/ts/func.ts").onToggleLike);
